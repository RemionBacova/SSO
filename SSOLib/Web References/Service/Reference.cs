...
namespace SSOLib.Service {
    ...
    public partial class AuthService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetUserRights", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void GetUserRightsAsync(string token, string platformId) {
            this.GetUserRightsAsync(token, platformId, null);
        }
        
        /// <remarks/>
        public void GetUserRightsAsync(string token, string platformId, object userState) {
            ...
            this.InvokeAsync("GetUserRights", new object[] {
                        token,
                        platformId}, this.GetUserRightsOperationCompleted, userState);
        }
