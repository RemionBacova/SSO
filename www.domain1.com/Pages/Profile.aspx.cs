...
public partial class _Profile : PrivatePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (CurrentUser != null)
        {
            ...
            SSOLib.Service.AuthService ssss = new SSOLib.Service.AuthService();

            lblUserRights.Text = ssss.GetUserRights(CurrentUser.Token, System.Configuration.ConfigurationManager.AppSettings["SITE_UID"]);
        }
    }
